...
import com.jellysoft.sundigitalindia.CityProduct;
 ...
 * Created by Arun.
 */
public class ServiceCityFragment extends Fragment {
    ...
    private void getCity() {
        ...
        jsObj.addProperty("method_name", "get_servicecity");
    ...
    private void displayData() {
        if (mListItem.size() == 0) {
            ...
            adapter.setOnItemClickListener(position -> {
                ...
                Intent intent = new Intent(requireActivity(), CityService.class);
