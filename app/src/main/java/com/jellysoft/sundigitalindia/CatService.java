...
public class CatService extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Service Category List");
        ...
        GridLayoutManager layoutManager = new GridLayoutManager(CatService.this, 1);
        ...
        if (NetworkUtils.isConnected(CatService.this)) {
            getCategoryItem();
        } else {
            Toast.makeText(CatService.this, getString(R.string.conne_msg1), Toast.LENGTH_SHORT).show();
        }
    ...
    private void getCategoryItem() {
        ...
        jsObj.addProperty("method_name", "get_service_by_cat_id");
    ...
    private void displayData() {
        if (mListItem.size() == 0) {
            ...
            if (isFirst) {
                isFirst = false;
                adapter = new ServiceAdapter(CatService.this, mListItem);
            ...
            adapter.setOnItemClickListener(new RvOnClickListener() {
                ...
                public void onItemClick(int position) {
                    ...
                    new SaveJob(CatService.this).userSave(jobId);
                    Intent intent = new Intent(CatService.this, ServiceDetailsActivity.class);
