...
import com.jellysoft.sundigitalindia.ReligionMatrimonyFemale;
 ...
 * Created by Arun.
 */
public class FemaleMatrimonyReligionFragment extends Fragment {
    ...
    private void getCategory() {
        ...
        jsObj.addProperty("method_name", "get_matrimony_female_religion");
        ...
        if (mListItem.size() == 0) {
            ...
            adapter.setOnItemClickListener(new RvOnClickListener() {
                ...
                public void onItemClick(int position) {
                    ...
                    Intent intent = new Intent(requireActivity(), ReligionMatrimonyFemale.class);
