...
public class FoodsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FoodsAdapter(Context context, ArrayList<ItemFood> dataList, CartDbHelper dbHelper) {
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder viewHolder, final int position) {
        if (viewHolder.getItemViewType() == VIEW_TYPE_ITEM) {
            ...
            holder.foodPlus.setOnClickListener(view -> {
                ...
                cursor.close();
                holder.foodCount.setText(String.valueOf(food.getCount()));
                RestaurantDetailsActivity.updatePrice();
            });
            ...
            Picasso.get().load(food.getImageUrl()).placeholder(R.drawable.placeholder).into(holder.foodImage);
...
//            }
    ...
    class ItemRowHolder extends RecyclerView.ViewHolder {
        TextView foodName, foodType, foodPrice, foodCount;
        ImageView foodImage, foodPlus, foodMinus;
        ...
        ItemRowHolder(View itemView) {
            ...
            foodImage = itemView.findViewById(R.id.imgProduct);
