...
import com.jellysoft.sundigitalindia.CatMatrimonyMale;
 ...
 * Created by Arun.
 */
public class MaleMatrimonyCategoryFragment extends Fragment {
    ...
    private void getCategory() {
        ...
        jsObj.addProperty("method_name", "get_matrimony_male_category");
        ...
        if (mListItem.size() == 0) {
            ...
            adapter.setOnItemClickListener(new RvOnClickListener() {
                ...
                public void onItemClick(int position) {
                    ...
                    Intent intent = new Intent(requireActivity(), CatMatrimonyMale.class);
