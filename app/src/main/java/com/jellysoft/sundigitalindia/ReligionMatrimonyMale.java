...
public class ReligionMatrimonyMale extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GridLayoutManager layoutManager = new GridLayoutManager(ReligionMatrimonyMale.this, 1);
        ...
        if (NetworkUtils.isConnected(ReligionMatrimonyMale.this)) {
            getCategoryItem();
        } else {
            Toast.makeText(ReligionMatrimonyMale.this, getString(R.string.conne_msg1), Toast.LENGTH_SHORT).show();
        }
    ...
    private void getCategoryItem() {
        ...
        jsObj.addProperty("method_name", "get_matrimony_male_by_religion_id");
        ...
        if (mListItem.size() == 0) {
            ...
            adapter.setOnItemClickListener(new RvOnClickListener() {
                ...
                public void onItemClick(int position) {
                    ...
                    new SaveJob(ReligionMatrimonyMale.this).userSave(jobId);
                    Intent intent = new Intent(ReligionMatrimonyMale.this, MatrimonyDetailsActivity.class);
