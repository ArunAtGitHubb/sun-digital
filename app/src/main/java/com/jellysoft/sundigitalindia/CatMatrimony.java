...
public class CatMatrimony extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GridLayoutManager layoutManager = new GridLayoutManager(CatMatrimony.this, 1);
        ...
        if (NetworkUtils.isConnected(CatMatrimony.this)) {
            getCategoryItem();
        } else {
            Toast.makeText(CatMatrimony.this, getString(R.string.conne_msg1), Toast.LENGTH_SHORT).show();
        }
    ...
    private void getCategoryItem() {
        ...
        jsObj.addProperty("method_name", "get_matrimony_by_cat_id");
    ...
    private void displayData() {
        if (mListItem.size() == 0) {
            ...
            if (isFirst) {
                isFirst = false;
                adapter = new MatrimonyAdapter(CatMatrimony.this, mListItem);
            ...
            adapter.setOnItemClickListener(new RvOnClickListener() {
                ...
                public void onItemClick(int position) {
                    ...
                    new SaveJob(CatMatrimony.this).userSave(jobId);
                    Intent intent = new Intent(CatMatrimony.this, MatrimonyDetailsActivity.class);
