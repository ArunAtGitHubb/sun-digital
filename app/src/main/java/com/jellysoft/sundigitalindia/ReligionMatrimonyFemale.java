...
public class ReligionMatrimonyFemale extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GridLayoutManager layoutManager = new GridLayoutManager(ReligionMatrimonyFemale.this, 1);
        ...
        if (NetworkUtils.isConnected(ReligionMatrimonyFemale.this)) {
            getCategoryItem();
        } else {
            Toast.makeText(ReligionMatrimonyFemale.this, getString(R.string.conne_msg1), Toast.LENGTH_SHORT).show();
        }
    ...
    private void getCategoryItem() {
        ...
        jsObj.addProperty("method_name", "get_matrimony_female_by_religion_id");
    ...
    private void displayData() {
        if (mListItem.size() == 0) {
            ...
            if (isFirst) {
                isFirst = false;
                adapter = new HomeMatrimonyAdapter(ReligionMatrimonyFemale.this, mListItem);
            ...
            adapter.setOnItemClickListener(new RvOnClickListener() {
                ...
                public void onItemClick(int position) {
                    ...
                    new SaveJob(ReligionMatrimonyFemale.this).userSave(jobId);
                    Intent intent = new Intent(ReligionMatrimonyFemale.this, MatrimonyDetailsActivity.class);
