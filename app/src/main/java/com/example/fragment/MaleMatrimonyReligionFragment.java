...
import com.jellysoft.sundigitalindia.ReligionMatrimonyMale;
 ...
 * Created by Arun.
 */
public class MaleMatrimonyReligionFragment extends Fragment {
    ...
    private void getCategory() {
        ...
        jsObj.addProperty("method_name", "get_matrimony_male_religion");
    ...
    private void displayData() {
        if (mListItem.size() == 0) {
            ...
            adapter.setOnItemClickListener(position -> {
                ...
                Intent intent = new Intent(requireActivity(), ReligionMatrimonyMale.class);
