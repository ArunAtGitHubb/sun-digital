...
public class LatestMaleMatrimony extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("மணமகன் வரன்கள்");
        ...
        if (NetworkUtils.isConnected(LatestMaleMatrimony.this)) {
            getLatestOrRecent();
        } else {
            Toast.makeText(LatestMaleMatrimony.this, getString(R.string.conne_msg1), Toast.LENGTH_SHORT).show();
        }
    ...
    private void getLatestOrRecent() {
        ...
        jsObj.addProperty("method_name", "get_latest_matrimony_male");
    ...
    private void displayData() {
        if (mListItem.size() == 0) {
            ...
            if (isFirst) {
                isFirst = false;
                adapter = new HomeMatrimonyAdapter(LatestMaleMatrimony.this, mListItem);
            ...
            adapter.setOnItemClickListener(position -> {
                ...
                Intent intent = new Intent(LatestMaleMatrimony.this, MatrimonyDetailsActivity.class);
