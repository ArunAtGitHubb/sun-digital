...
import com.jellysoft.sundigitalindia.CatService;
 ...
 * Created by Arun.
 */
public class MatrimonyCategoryFragment extends Fragment {
    ...
    private void getCategory() {
        ...
        jsObj.addProperty("method_name", "get_matrimonycategory");
        ...
        if (mListItem.size() == 0) {
            ...
            adapter.setOnItemClickListener(new RvOnClickListener() {
                ...
                public void onItemClick(int position) {
                    ...
                    Intent intent = new Intent(requireActivity(), CatMatrimony.class);
