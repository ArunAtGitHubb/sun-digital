...
public class UsedProduct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("உபயோகித்த பொருட்கள் பட்டியல்");
        ...
        if (NetworkUtils.isConnected(UsedProduct.this)) {
            getLatestOrRecent();
        } else {
            Toast.makeText(UsedProduct.this, getString(R.string.conne_msg1), Toast.LENGTH_SHORT).show();
        }
   recyclerView.addOnScrollListener(new EndlessRecyclerViewScrollListener(layoutManager) {
    ...
    private void getLatestOrRecent() {
        ...
        jsObj.addProperty("method_name", "get_all_used_product");
    ...
    private void displayData() {
        if (mListItem.size() == 0) {
            ...
            if (isFirst) {
                isFirst = false;
                adapter = new ProductAdapter(UsedProduct.this, mListItem);
            ...
            adapter.setOnItemClickListener(new RvOnClickListener() {
                ...
                public void onItemClick(int position) {
                    ...
                    Intent intent = new Intent(UsedProduct.this, ProductDetailsActivity.class);
