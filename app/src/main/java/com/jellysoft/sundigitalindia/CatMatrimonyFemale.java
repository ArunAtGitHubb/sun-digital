...
public class CatMatrimonyFemale extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GridLayoutManager layoutManager = new GridLayoutManager(CatMatrimonyFemale.this, 1);
        ...
        if (NetworkUtils.isConnected(CatMatrimonyFemale.this)) {
            getCategoryItem();
        } else {
            Toast.makeText(CatMatrimonyFemale.this, getString(R.string.conne_msg1), Toast.LENGTH_SHORT).show();
        }
    ...
    private void getCategoryItem() {
        ...
        jsObj.addProperty("method_name", "get_matrimony_female_by_cat_id");
        ...
        if (mListItem.size() == 0) {
            ...
            adapter.setOnItemClickListener(new RvOnClickListener() {
                ...
                public void onItemClick(int position) {
                    ...
                    new SaveJob(CatMatrimonyFemale.this).userSave(jobId);
                    Intent intent = new Intent(CatMatrimonyFemale.this, MatrimonyDetailsActivity.class);
