 ...
 * Created by Arun.
 */
public class ProductCityFragment extends Fragment {
    ...
    private void getCity() {
        ...
        jsObj.addProperty("method_name", "get_productcity");
        ...
        if (mListItem.size() == 0) {
            ...
            adapter.setOnItemClickListener(new RvOnClickListener() {
                ...
                public void onItemClick(int position) {
                    ...
                    Intent intent = new Intent(requireActivity(), CityProduct.class);
