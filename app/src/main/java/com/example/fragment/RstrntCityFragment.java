...
import com.jellysoft.sundigitalindia.CityRstrnt;
 ...
 * Created by Arun.
 */
public class RstrntCityFragment extends Fragment {
    ...
    private void getCity() {
        ...
        jsObj.addProperty("method_name", "get_foodcity");
    ...
    private void displayData() {
        if (mListItem.size() == 0) {
            ...
            adapter.setOnItemClickListener(position -> {
                ...
                Intent intent = new Intent(requireActivity(), CityRstrnt.class);
