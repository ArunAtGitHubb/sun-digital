...
public class TutyCityRstrnt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GridLayoutManager layoutManager = new GridLayoutManager(TutyCityRstrnt.this, 3);
    ...
    private void getCategoryItem() {
        ...
        jsObj.addProperty("method_name", "get_restaurant_by_tuty");
    ...
    private void displayData() {
        if (mListItem.size() == 0) {
            Log.d("result2", "inside emty tuty");
            lyt_not_found.setVisibility(View.VISIBLE);
        } else {
            ...
            adapter.setOnItemClickListener(position -> {
                ...
                Intent intent = new Intent(TutyCityRstrnt.this, RestaurantDetailsActivity.class);
